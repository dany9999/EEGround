...
if __name__ == "__main__":
    # Split pazienti
    train_patients = [f"chb{str(i).zfill(2)}" for i in range(1,5)]
    val_patients   = [f"chb{str(i).zfill(2)}" for i in range(1, 5)]
    test_patients  = [f"chb{str(i).zfill(2)}" for i in range(1, 5)]
