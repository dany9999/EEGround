...
# FULL DATA PROCESS
    ...
    # PARAMETERS
    signals_path = "CHB-MIT/Raw"  # Path to the data main directory
    clean_path = "CHB-MIT/clean_signals"  # Path where to store clean data
    ...
    pacient = "17"
    num = "03"  # Reference file
    summary_index = 0  # Index of channels summary reference
    start = 1  # Number of first file to process
    end = 40  # Number of last file to process
    # Start the process
